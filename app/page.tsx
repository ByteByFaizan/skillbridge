  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="section-bg py-16 md:py-24">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:gap-12">
          <div className="lg:max-w-xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link href="/discover">
                <Button size="lg">Get My Career Roadmap</Button>
              </Link>
              <Link href="/discover">
          ...
          <div className="mt-12 lg:mt-0 lg:flex-shrink-0">
            <div className="flex h-64 items-center justify-center rounded-2xl bg-[var(--primary)]/10 md:h-80 lg:h-96">
              <span className="text-[var(--muted)]">Illustration placeholder</span>
            </div>
          </div>
        </div>
      </section>
