                ...
                <section className="relative pt-28 pb-16 sm:pt-40 sm:pb-24 overflow-hidden">
                    ...
                    <div className="relative max-w-[1060px] mx-auto px-4">
                        <div className="flex flex-col items-center text-center gap-8">
                            ...
                            <h1 className="max-w-[720px] text-[#37322f] text-4xl sm:text-5xl md:text-[72px] font-normal leading-tight md:leading-[1.15] font-display animate-fade-in-up text-balance">
                        ...
                        <RevealOnScroll>
                            <div className="grid gap-10 md:grid-cols-[1.2fr_1fr] md:gap-16 items-start">
                                ...
                                <div>
                                    ...
                                    <div className="mt-6 space-y-4 text-[15px] leading-[1.8] text-[#49423D]/85">
                                        <p>
                                ...
                                <div className="relative">
                                    <div className="border-l-[3px] border-[#37322f]/20 bg-white p-8 sm:p-10 shadow-[0_2px_16px_rgba(55,50,47,0.04)] md:mt-12">
                        ...
                        <div className="grid gap-6 sm:grid-cols-3">
                            {values.map((value, i) => (
                                <RevealOnScroll key={value.title} delay={i * 120}>
                                    <div className="group relative bg-white border border-[#e0dedb]/80 p-8 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-[#37322f]/15 hover:shadow-[0_12px_40px_rgba(55,50,47,0.07)] hover:-translate-y-1.5 cursor-default h-full">
                                        {/* Icon */}
                                        <div className="inline-flex rounded-xl bg-[#f7f5f3] p-3  text-[#37322f] transition-all duration-300 group-hover:bg-[#37322f] group-hover:text-white group-hover:scale-110 group-hover:shadow-[0_4px_16px_rgba(55,50,47,0.2)]">
                                            <value.icon />
                                        </div>

                                        <h3 className="mt-6 text-lg font-semibold text-[#37322f]">
                                            {value.title}
                                        </h3>
                                        <p className="mt-3 text-sm leading-[1.75] text-[#49423D]/75">
                                            {value.description}
                                        </p>
                        ...
                        <div className="grid gap-8 sm:grid-cols-2 max-w-[680px] mx-auto">
                            ...
                            <RevealOnScroll delay={0}>
                                ...
                                >
                                    ...
                                    <div className="relative w-28 h-28 rounded-full overflow-hidden border-[3px] border-[#e0dedb] group-hover:border-[#37322f]/30 transition-all duration-500 group-hover:shadow-[0_8px_30px_rgba(55,50,47,0.15)] group-hover:scale-105">
                                        <Image
                                    ...
                                    <p className="mt-1 text-sm font-medium text-[#49423D]/60 uppercase tracking-[0.1em]">
                                        CEO &amp; Co-Founder
                                    </p>

                                    {/* GitHub link indicator */}
                                    <div className="mt-4 inline-flex items-center gap-1.5 text-xs font-medium text-[#49423D]/40 group-hover:text-[#37322f] transition-colors duration-300">
